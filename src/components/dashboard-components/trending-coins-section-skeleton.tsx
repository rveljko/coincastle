...
type TrendingCoinsSectionSkeletonProps = {
  className?: string
}

export default function TrendingCoinsSectionSkeleton({
  className,
}: TrendingCoinsSectionSkeletonProps) {
  return (
    <Section className={className}>
      <div className="flex h-full flex-col justify-between gap-2">
        ...
        <TrendingCryptoCoinsTableSkeleton numberOfCoins={5} />
      </div>
    </Section>
  )
}
