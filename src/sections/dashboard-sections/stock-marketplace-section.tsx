...
export default function StockMarketplaceSection() {
  return (
    <Section>
      <h1 className="mb-2">Stock Marketplace</h1>
      <StocksTableFilter />
            ...
            <Dropdown.Details>
              ...
              >
                ...
                <div className="flex items-center gap-1">
                  ...
                  <FormField.Input
                    optional
                    placeholder={currencyFormatter(1000)}
                    type="tel"
              ...
              <form
                ...
                onSubmit={(e) => {
                  ...
                  if (filters.marketCap.to !== prevFilters.marketCap.to) {
                    setFilterParam('marketcap-to', filters.marketCap.to)
                    setPrevFilters({
                      ...prevFilters,
                      marketCap: {
                        ...prevFilters.marketCap,
            ...
            <Dropdown.Details>
              <form
                ...
                onSubmit={(e) => {
                  ...
                  if (filters.volume.to !== prevFilters.volume.to) {
                    setFilterParam('volume-to', filters.volume.to)
                    setPrevFilters({
                      ...prevFilters,
                      volume: {
                        ...prevFilters.volume,
              ...
              >
                ...
                <div className="flex items-center gap-1">
                  ...
                  <FormField.Input
                    optional
                    placeholder={currencyFormatter(1_000_000)}
                    type="tel"
