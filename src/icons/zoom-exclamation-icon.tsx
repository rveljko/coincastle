type ZoomExclamationIconProps = {
  className?: string
}

export default function ZoomExclamationIcon({
  className,
}: ZoomExclamationIconProps) {
  return (
    <svg
      width="22"
      height="22"
